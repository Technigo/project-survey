...
export const Summary = ( {name, email, canContributeWith, yearsOfExperience, likeMyJob} ) => {
  ...
  return (
    <section className="summary-box">
      ...
      <div className="answers-wrapper">
        ...
        <p className="summary-text" tabIndex="0"><span className="bold-summary-text">I like my job this much on a scale from 1 to 10: </span>{likeMyJob}</p>
