      ...
      {!showSummary ? (
        <form onSubmit={handleSubmit}>
          <header id="header">
            ...
            <a href="#drink"><img className="glogg" src="../assets/gloggdown.png" alt="glogg" /></a>
          </header>
          <section className="section-content drink" id="drink">
            ...
            <button type="button"><a href="#snack">Next</a></button>
          </section>
          ...
          <section className="section-content snack" id="snack">
            ...
            <input
              ...
              value={snack}
              required />
            <button type="button"><a href="#party">Next</a></button>
          </section>
