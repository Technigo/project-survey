    ...
    <>
      <form className="third-question" onSubmit={(event) => event.preventDefault()}>
        ...
        <div className="day-select-text">
          ...
          <button className="last-button" onClick={checkInput()} aria-label="Tab to reveal your dream vacation"><a href="#final-text" aria-hidden="true" tabIndex="-1">Dream away!</a></button>
        </div>       
      </form>
