    ...
    <>
      <div className="form">
        <section className="text-summary">
          ...
          <div>On this {weatherToUse} morning, {characterTitle} Theone {genderToUse === "non-binary" ? "ride" : "rides"} {pronounPossessive} {vehicleToUse} to work. As every morning, {pronounSubject} {genderToUse === "non-binary" ? "take" : "takes"} St. Henry then {genderToUse === "non-binary" ? "turn" : "turns"} on St. George to follow the river for some kilometres at a {speedWordToUse()} pace. Doing so, as every morning, {pronounSubject} {genderToUse === "non-binary" ? "eat" : "eats"} some {snackToUse}, before throwing the packaging behind {pronounDirect} on the road. {pronounSubjectCapitalized} {genderToUse === "non-binary" ? "arrive" : "arrives"} in front of the skyscraper where {pronounPossessive} office is located, {genderToUse === "non-binary" ? "lock" : "locks"} {pronounPossessive} {vehicleToUse} and {genderToUse === "non-binary" ? "enter" : "enters"}.<p></p>
“Hello {notFriendNameToUse}, how are you?” {genderToUse === "non-binary" ? "say" : "says"} Theone. <p></p>
“As usual, {characterName}, what about you?” answers the door attendant. <p></p>
“Ready for another day at work, but please open the door for me!” {genderToUse === "non-binary" ? "exclaim" : "exclaims"} {characterTitle} Theone. <p></p>
<p></p>
...
<p></p>
{characterTitle} Theone {genderToUse === "non-binary" ? "take" : "takes"} the stairs, {genderToUse === "non-binary" ? "arrive" : "arrives"} on the third floor and {genderToUse === "non-binary" ? "go" : "goes"} to {pronounPossessive} desk, not without grabbing a cup of lukewarm {beverageToUse}, passing by the small kitchen. <p></p>
“{friendNameToUse}, once again you disconnected the {beverageToUse === 'coffee' ? 'coffee maker' : 'teapot'} by mistake!” {genderToUse === "non-binary" ? "say" : "says"} {characterTitle} Theone to a colleague. <p></p>
{pronounSubjectCapitalized} {genderToUse === "non-binary" ? "immerse" : "immerses"} {pronounReflexive} immediately in a file. {pronounSubjectCapitalized} will certainly need some time before moving on to the next. <p></p>
<p></p>
