...
export const Summary = ({ backFront, loneTeam, learnKnow }) => {
  ...
  const message2 = 'Well, I\'m primarily a frontend developer and even though I love broadening my development knowledge I don\'t think I\'m the right fit for you right now. But if you\'re still interested:';
  ...
  return (
    <div className="summary-container">
      <h3 className="summary-heading">Hello there 👋</h3>
      <p className="summary-sub-heading">First of all, thank you for taking the survey!</p>

      <p className="summary-text">I&apos;m a developer named Fredrik.</p>
