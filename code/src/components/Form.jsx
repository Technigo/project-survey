...
import { TipiChart } from "./TipiChart";
import TiviDropDownOne from "./TiviDropDownOne";
...
export const Form = () => {
  ...
  return (
    <section className="page">
      ...
      {pageNumber === 1 && <Name name={name} askName={askName} error={error} />}

      {pageNumber === 2 && (
        <Gender gender={gender} askGender={askGender} error={error} />
      )}

      {pageNumber === 3 && <AgeGroup age={age} askAge={askAge} error={error} />}
  ...
  // SINGLE PAGE RETURN FOR TESTING
  // return (
  //     <section className="page">
  //     <Header />
  //     <ProgressBar
