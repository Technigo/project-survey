  ...
  return (
    <section className="overview-container">
      ...
      <div className="speech-bubble">
        ...
        <p>Our office in <span className="bold">{countryInput}</span> will contact you at this <span className="bold">{emailInput} adress</span>.
        Your age between <span className="bold">{ageInput}</span> is common in our games. 
        While you wait us to reach out to you, read more about us on our webpage <a href="https://www.netflix.com/se/title/81040344" 
