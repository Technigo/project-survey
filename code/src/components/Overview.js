      ...
      <div className="flex-boxes">
        ...
        <section className="correct-answers-section">
          ...
          <p className="highlight-text">
            ...
            The find() method returns just Maxsymilian's cheese sandwich while
            the filter() method returns the bag with all type of sandwiches!
          </p>
          ...
          <p className="correct-answer">
            <span>A4:</span>False; a parameter is the value inside a function
            once is declared and an argument is the value inside a function once
            is invoked.
          </p>
