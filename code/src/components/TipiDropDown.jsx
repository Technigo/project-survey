...
const TipiDropDown = (props) => {
    return (
        ...
        <h3>Here are a number of personality traits that may or may not apply to you. Please select a number next to each statement to indicate the extent to which <span className="underline">you agree or disagree with that statement.</span></h3> 
        <h3>You should rate the extent to which <em>the pair</em> of traits applies to you, <span className="underline">even if one characteristic applies more strongly than the other.</span></h3>
        <h4>I see myself as:</h4>
