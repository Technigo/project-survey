...
export const Summary=({nameInput, interestInput, locationInput, emailInput, restart})=>{
    return( <section>
        ...
        <h2> We will send updates to <span className="purpletext">{emailInput}</span> about <span className="purpletext">{interestInput}</span> in <span className="purpletext">{locationInput}</span></h2>
