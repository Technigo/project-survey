  ...
  <section className="summary-container">
    <div className="story-container">
      ...
      <div className="story-container-final">
        ...
        <p>
          So the dragon now had a <span className="red">{adjectiveSecond}</span>{' '}
          dilemma. I’ll have to build the <span className="red">{animal}</span>{' '}
          its own house, he sighed, when a{' '}
        </p>
        <p>
        ...
        <p>
          they would toast marshmallows/apples/bubble-gum pie (yum) on the fire
          that the Dragons sneezes provided.{' '}
        </p>
        <p>The End.</p>
      </div>
