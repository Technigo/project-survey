...
const Summary = ({ name, radioButton }) => {
  return (
    <>
        ...
        <div className="story-container">
          ...
          <div className="story-container-final">
            <p>
              ...
              <span className="red">{radioButton}</span> Dragon, who drove
              around town in a adjective________ wagon.
            </p>
            <p>
              The Dragon was lonely, and said, this is baloney, if I could find
              a friend, if only.
            </p>
            <p>
              So the dragon set out to find a companion. A pet, he squealed,
              I’ll name it Brandon.{' '}
            </p>
            <p>
              But the Dragon did not know what makes a good pet, he settled for
              a animal________, that’s what I’ll get.{' '}
            </p>
            <p>
            ...
            <p>
              So the dragon now had a puzzling/obscure/funny dilemma. I’ll have
              to build the insert animal its own house, he sighed, when a{' '}
            </p>
            <p>
