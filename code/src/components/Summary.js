  ...
  return (
    <div className="summaryContainer">
      <div className="summaryWrapper">
        ...
        <p>You would rather go for {props.foodPreference}... We assume that it was a tough decision to take!</p>
        ...
        <iframe title="happyGif" style={{ borderRadius: 100 }} src="https://giphy.com/embed/Lb4IZLmCfALhm" width="180" height="180" frameBorder="0" class="giphy-embed" allowFullScreen></iframe>
      </div>
