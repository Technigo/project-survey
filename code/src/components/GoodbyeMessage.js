...
export const GoodbyeMessage = (props) => {
  ...
  return (
    <div className="containerBye">
      ...
      <span><iframe style={{ width: 200, height: 200, borderRadius: 100 }} src="https://giphy.com/embed/3o6YghZV15YGZoOtIk" width="480" height="360" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p></p></span>
