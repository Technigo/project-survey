...
export const Form = () => {
    ...
    return <section class="survey">
        ...
        <form onSubmit={(e) => { e.preventDefault() }} >
            ...
            {section === 'callsign' && (
                <section>
                    <Radio onRadioInput={handleRadioInput} />
            ...
            {section === 'quote' && (
                <section>
                    <Text onTextInput={handleTextInput} />
            ...
            {section === 'rate' && (
                <section>  
                    <Dropdown onDropInput={handleDropInput} />
            ...
            {section === 'summary' && (
                <section class="summary" tabIndex="0">
                    <p tabIndex="0">{radioInput}, take this boogie off my tail!</p>
