...
export function App() {
  ...
  const onAdjectivesArrayChange = (adjective) => {
    if (adjectivesArray.includes(adjective)) {
      const filteredAdjectivesArray = adjectivesArray.filter(() => adjectivesArray !== adjective);
      ...
      <div className="survey-wrapper">
        ...
        {step === 7 && (
          genre === 'pop' ? <Classic name={name} reason={reason} location={location} feel={feel} genre={genre} />
            ...
            : genre === 'RB' ? <RB name={name} reason={reason} location={location} feel={feel} genre={genre} />
